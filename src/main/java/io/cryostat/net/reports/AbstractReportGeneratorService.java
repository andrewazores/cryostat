...
abstract class AbstractReportGeneratorService implements ReportGeneratorService {
    ...
    protected Path getRecordingFromLiveTarget(String recordingName, ConnectionDescriptor cd)
            throws Exception {
    ...
    protected Path copyRecordingToFile(JFRConnection conn, String recordingName, Path path)
            throws Exception {
